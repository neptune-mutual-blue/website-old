...
const Check = styled.input`
  ...
  height: 20px;
  border-radius: 50%;
  border: 1px solid ${props => props.theme.isLightMode ? colors[primaryColorKey][600] : colors.gray[300]};
  ...
  &:checked {
    ...
    /* background-color: ${props => props.theme.isLightMode ? colors[primaryColorKey][600] : 'transparent'}; */
    background-color: ${colors[primaryColorKey][600]};
    border: 1px solid ${props => props.theme.isLightMode ? 'inherit' : 'transparent'};
  }
`
